...
namespace ver1UnitTests
{
    ...
    public class UnitTestMultifunctionalDevice
    {
        ...
        // weryfikacja, czy po wywołaniu metody `Fax` i włączonej kopiarce w napisie pojawia się słowo `Fax`
        // wymagane przekierowanie konsoli do strumienia StringWriter
        [TestMethod]
        public void MultifunctionalDevie_Fax_Device_On()
        {
            var copier = new MultifunctionalDevice();
            copier.PowerOn();
        ...
        // wymagane przekierowanie konsoli do strumienia StringWriter
        [TestMethod]
        public void MultifunctionalDevice_Fax_Device_off()
        {
            var copier = new MultifunctionalDevice();
            copier.PowerOff();
